...
gulp.task('init', function(){
    runSequence('fileinclude', 'sprite', 'scss', 'js:min', 'img:min', 'bs');
});

gulp.task('watch', function () {
    watch( htmlFileDir, function () {
...
gulp.task('product', function(){
    runSequence('fileinclude', 'sprite', 'scss', 'js:product','img:min');
});